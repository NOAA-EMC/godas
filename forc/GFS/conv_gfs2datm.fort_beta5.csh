...
set hdir = /gpfs/dell2/emc/modeling/noscrub/Hyun-Chul.Lee/GFSv
set sdir = ${hdir}/Reanal
#set sdir = /gpfs/dell2/ptmp/Hyun-Chul.Lee/Tmp/Reanal
set tdir = ${hdir}/GFS2DATM
set wdir = ${hdir}/Work
set grb2 = /u/Hyun-Chul.Lee/Tools/wgrib2
...
/bin/cp ${hdir}/conv_gfs2datm_long_beta5 conv_gfs2datm_long_beta5
