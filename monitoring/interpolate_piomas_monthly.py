...
varAttrs = {
            'thickness': {'long_name': 'sea ice thickness',
                     'units': 'm'},
...
class Grid(Plot):
    ...
    def source_grid(self, mm=1):
        ...
        self.srclat = source.variables['latitude'][:]
        self.srclon = source.variables['longitude'][:]
...
def write_to_netcdf(lon, lat, data, filo, months=None, fill_value=1e20, variable='thickness', attributes=None):
